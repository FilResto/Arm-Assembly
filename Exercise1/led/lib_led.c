...
void LED_init(void) {
  ...
  LPC_PINCON->PINSEL4 &= 0xFFFF0000;	//PIN mode GPIO (00b value per P2.0 to P2.7)
	LPC_GPIO2->FIODIR   |= 0x000000FF;  //P2.0...P2.7 Output (LEDs on PORT2 defined as Output) vuold dire che negli 8 bit meno significativi mi deve scrivere un 1, siccome stiamo facendo una OR e singifica dire che significa che siamo in output
