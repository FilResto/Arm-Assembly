...
IS_ODD:	#riprendere da qua per unrolling
	;p= v1[i] / ((double)m* i))																;
	l.d F2, v1(R2)																			;FDEMW	1    30
	...
	div.d F2, F2, F3																		;		   FDddddddddddddddddddddMW 16
...
CONTINUE:
	...
	add.d F13,F11,F12          # ((p * v2[i]) + v3[i]) + v4[i]							;	           FDXXXMW 2
	...
	s.d F15,v6(R2)             																					;  FsssssssssssssssDEMW 0
